...
const schema = z.object({
  ...
  featuredImageSrc: z.string().min(1, 'Add a featured image'),
  featuredImageAlt: z.string().min(1, 'Add alt text for the featured image'),
...
export function AdminBlogFormPage() {
  ...
  const {
    ...
    defaultValues: { status: 'draft', author: 'Icebrim Team' },
  });
