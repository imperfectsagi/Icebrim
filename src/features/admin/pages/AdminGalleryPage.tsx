    ...
    <div>
      ...
      {confirmDeleteId && (
        <ConfirmDeleteDialog
          ...
          onConfirm={() => {
            deleteImage.mutate(confirmDeleteId);
  ...
  return (
    ...
    >
      <div className="bg-white rounded-[var(--radius-card)] p-6 max-w-sm w-full">
        <h2 className="font-semibold mb-2">Delete this gallery item?</h2>
        <p className="text-sm text-[var(--color-ink-soft)] mb-6">
          This action cannot be undone. The item will be removed from the public Gallery page
          immediately.
        </p>
