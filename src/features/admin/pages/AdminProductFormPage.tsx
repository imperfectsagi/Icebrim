  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} noValidate className="space-y-6 max-w-3xl">
        ...
        <AdminCard className="space-y-4">
          <h2 className="font-semibold">Video (optional)</h2>
          <p className="text-sm text-[var(--color-ink-soft)]">
            Shown alongside the product images above on the product page.
          </p>
          <ImageUploadField
            accept="image+video"
            mediaType="video"
            value={watch('videoUrl')}
            onChange={(src) => setValue('videoUrl', src, { shouldValidate: true })}
            category="products"
          />
        </AdminCard>
